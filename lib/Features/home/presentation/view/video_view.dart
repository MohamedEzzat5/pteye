      ...
      return Scaffold(
        ...
        body: Center(
          ...
          Padding(
            ...
            child: Text(textAlign: TextAlign.center,'فشل تحميل الفيديو برجاء التأكد من الاتصال بالانترنت واعادة المحاولة لاحقا',style: Styles.textStyle20.copyWith(color: Colors.white),),
          ),
...
//       //aspectRatio: 16 / 9, // You can adjust this ratio based on your video aspect ratio
//       autoPlay: true,
//       zoomAndPan: true,
//       allowFullScreen: true,
//       looping: false,
//       showControls: true,
//       errorBuilder: (context, errorMessage) => const Text('برجاء التأكد من الاتصال بالانترنت',style: Styles.textStyle22,),
//     );
//
//   }
//
